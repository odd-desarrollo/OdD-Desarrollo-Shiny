...
loc="C:/Users/odd/Desktop/git/OdD-Desarrollo-Shiny/app/cuadros_prueba.xlsx" #CAMBIAR UBICACIÓN
...
server <- function(input, output, session) {
  ...
  ID<-reactive({
    ...
    return(which.min(leven_dist))#la distancia mínima indica el par de nombres mÃ¡s similar
  })
